...
> **Android: stage 3 (spoken cues)** — Android ships in stages ([ADR 0025](0025-android-staged-migration.md)); the Android provisions below belong to stage 3 (spoken cues): speech over Android audio focus; the haptic half already ships in stage 1. Check ADR 0025's stage table for whether they have shipped.
