...
|---|---|---|---|---|---|
| Android support (Material 3 / Compose islands, dynamic colour; not a 1:1 design) | **Planned** — stage 1 of 7 built 2026-09-20; ADR 0025's stage table tracks the rest | Feasible (adapters behind the ADR 0003 ports; `@expo/ui/jetpack-compose` already installed) | Fully local (no Android backup analogue wired; Play services untouched) | — (ADR written from the stage-1 build) | [0025 (proposed)](../adr/0025-android-staged-migration.md) · [stage 1 plan](../superpowers/plans/2026-09-20-android-stage-1-basics.md) |
