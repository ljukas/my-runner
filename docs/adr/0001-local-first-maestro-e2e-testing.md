...
> **Android: stage 7 (release pipeline)** — Android ships in stages ([ADR 0025](0025-android-staged-migration.md)); the Android provisions below belong to stage 7 (release pipeline): the `e2e-android` lane. Check ADR 0025's stage table for whether they have shipped.
