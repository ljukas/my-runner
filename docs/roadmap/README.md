...
| Plan screen: focus the current week (de-emphasize / collapse / hide completed weeks) | Researched | Feasible-with-caveats (native @expo/ui collapse/swipe; first-use spike) | Fully local (kv-store plan-view state — hidden + collapsed weeks persist; no migration) | [2026-07-22](../superpowers/research/2026-07-22-plan-week-focus-visibility.md) | — |
