...
| 3 — Spoken cues | expo-speech over Android audio focus (ducking semantics differ, ADR 0009); audio-cues onboarding step returns. | `cue-service/adapter.android.ts`; a local audio-focus connector if the plan's Decision A is taken. | Planned — [plan](../superpowers/plans/2026-09-21-android-stage-3-spoken-cues.md) |
