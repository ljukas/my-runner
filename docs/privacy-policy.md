...
database on your device. They are included in your iPhone's own iCloud
backup, under your Apple account and Apple's terms; RunBro has no access to
that backup and no account of its own.
